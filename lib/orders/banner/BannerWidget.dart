...
class BannerWidget extends StatefulWidget {
  ...
  BannerWidget(double this.height, List<BannerItem> this.datas,
      ...
      Color this.backgroundColor = const Color(0x00000000),
      bool this.isHorizontal = false,
      double this.mPading = 5.0,
      double this.mImageRadius = 10.0,
      Alignment this.pointAlignment = Alignment.bottomCenter,
    ...
    return new Container(
      ...
      child: Stack(
        children: <Widget>[
          getViewPager(),
          new Align(
            alignment: widget.pointAlignment,
      ...
      itemBuilder: (context, index) {
        return InkWell(
            ...
            child: widget.build == null
                ? Container(
                    margin: EdgeInsets.all(widget.mPading),
                    child: ClipRRect(
