...
class MPageController extends ScrollController {
...
final MPageController _defaultPageController = MPageController();
...
class MPageView extends StatefulWidget {
  ...
  /// view is scrolled.
  final MPageController controller;
...
class _PageViewState extends State<MPageView> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<MPageController>('controller', widget.controller, showName: false));
